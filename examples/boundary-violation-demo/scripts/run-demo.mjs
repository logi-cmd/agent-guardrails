...
const baselineFiles = {
  "src/orders/controllers/refund-controller.ts": "import { loadRefundSummary } from \"../services/refund-service\";\n\nfunction buildRefundResponse() {\n  return loadRefundSummary();\n}\n\nbuildRefundResponse();\n",
  "src/orders/services/refund-service.ts": "export function loadRefundSummary() {\n  return [];\n}\n",
  "src/orders/data/refund-repo.ts": "export function loadRefundRecords() {\n  return [];\n}\n",
  "tests/refund-controller.test.ts": "export const refundControllerBaseline = true;\n"
};
...
function printScenarioSummary(result, scenario) {
  ...
  assert.equal(
    findingCodes.includes("boundary-violation-forbidden-import"),
    false,
    `Scenario ${scenario.name} should clear the boundary finding.`
  );
  console.log("- Proof signal: no boundary-violation finding remains");
}
