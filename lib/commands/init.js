...
function classifyWrites(targetDir, adapters, presetConfig, hasCI, locale) {
  ...
  const replacements = {
    ...
    PRESET_NAME: presetConfig.preset || "node-service",
  ...
  const adapterWrites = {
    "openclaw": { path: "OPENCLAW.md", template: "adapters/openclaw/OPENCLAW.md" },
    ...
    "openhands": { path: ".agents/skills/agent-guardrails.md", template: "adapters/openhands/agent-guardrails.md" },
    "windsurf": { path: ".windsurf/rules/agent-guardrails.md", template: "adapters/windsurf/agent-guardrails.md" },
    "opencode": { path: ".opencode/rules/agent-guardrails.md", template: "adapters/opencode/agent-guardrails.md" },
