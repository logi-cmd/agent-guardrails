...
function mergeClaudeSettings(repoRoot) {
  ...
  ensureHook("PreToolUse", "Write|Edit|MultiEdit", "node .agent-guardrails/hooks/claude-code-pre-tool.cjs");
  ensureHook("PostToolUse", "Write|Edit|MultiEdit", "node .agent-guardrails/hooks/claude-code-post-tool.cjs");
