...
export const setupAgentDefinitions = {
  ...
  openclaw: {
    ...
    targetLocationDescription:
      "Your OpenClaw workspace config file, commonly `.openclaw/mcp.json`.",
  ...
  windsurf: {
    ...
    adapterId: "windsurf",
    targetKind: "workspace-config",
    targetLocation: ".windsurf/mcp.json",
    targetLocationDescription:
      "Your Windsurf workspace config file, commonly `.windsurf/mcp.json`.",
    safeRepoConfigPath: ".windsurf/mcp.json",
    snippet: jsonSnippet,
    firstChatPrompt: shortFirstChatPrompt,
    canonicalFlow,
  ...
  opencode: {
    ...
    adapterId: "opencode",
    targetKind: "repo-local-config",
    targetLocation: ".opencode/mcp.json",
    targetLocationDescription:
      "Your OpenCode workspace config file, commonly `.opencode/mcp.json`.",
    safeRepoConfigPath: ".opencode/mcp.json",
    snippet: jsonSnippet,
    firstChatPrompt: shortFirstChatPrompt,
    canonicalFlow,
