...
export const setupAgentDefinitions = {
  ...
  "claude-code": {
    ...
    repoLocalHelperFiles: [
      "CLAUDE.md",
      path.posix.join(".claude", "settings.json"),
      path.posix.join(".agent-guardrails", "hooks", "claude-code-pre-tool.cjs"),
      path.posix.join(".agent-guardrails", "hooks", "claude-code-post-tool.cjs")
    ]
  },
  cursor: {
    id: "cursor",
  ...
  gemini: {
    ...
    targetLocationDescription:
      "Your Gemini CLI repo settings file, commonly `.gemini/settings.json` in the repo root.",
    safeRepoConfigPath: ".gemini/settings.json",
    ...
    repoLocalHelperFiles: [
      "GEMINI.md",
      path.posix.join(".agent-guardrails", "hooks", "gemini-pre-tool.cjs"),
      path.posix.join(".agent-guardrails", "hooks", "gemini-post-tool.cjs")
    ]
  }
};
